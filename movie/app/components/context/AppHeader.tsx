...
export default function AppHeader() {
  ...
  return (
    <header className="flex flex-wrap sm:flex-nowrap justify-between items-center p-5 bg-gray-800 text-white shadow-md sticky top-0 z-50">
      ...
      <Link href="/favorites" className="order-2 sm:order-3">
        <button 
            type="button" 
